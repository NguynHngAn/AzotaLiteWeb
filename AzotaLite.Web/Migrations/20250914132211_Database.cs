        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerTeacherId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_AspNetUsers_OwnerTeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmissionAnswers_Choices_ChoiceId",
                        column: x => x.ChoiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_OwnerTeacherId_Title",
                table: "Exams",
                columns: new[] { "OwnerTeacherId", "Title" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_ClassroomId_FullName",
                table: "Students",
                columns: new[] { "ClassroomId", "FullName" });

            migrationBuilder.CreateIndex(
                name: "IX_SubmissionAnswers_ChoiceId",
